...
class TestQwen25Omni(unittest.TestCase):
    ...
    def test_get_rope_index_video_with_audio(self):
        ...
        image_grid_thw = mx.random.randint(-1000000000, 1000000000, (0, 3), dtype=mx.int64)
        ...
        # fmt: on
        expected_position_ids = mx.array(expected_position_ids_data, dtype=mx.int64)
        ...
        print(f"{input_ids=}, {image_grid_thw=}, {video_grid_thw=}, {use_audio_in_video=}, {audio_seqlens=}, {second_per_grids=}")
        position_ids, mrope_position_deltas = self.model.get_rope_index(
            input_ids=input_ids,
            image_grid_thw=image_grid_thw,
        ...
        print(f"{position_ids=}, {expected_position_ids=}")
        self.assertTrue(mx.array_equal(position_ids, expected_position_ids))
